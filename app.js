...
const activities = [
  ...
  },
  {
    ...
    rotation: [
      { date: 'Jul 8', spot: 'Slim Chickens', address: '1250 E State St, Lehi, UT 84043' },
      { date: 'Jul 15', spot: "Houston's Hot Chicken", address: '1085 E Main St, Lehi, UT 84043' },
      { date: 'Jul 22', spot: 'R&R BBQ', address: '1628 W Traverse Pkwy, Lehi, UT 84043' },
      { date: 'Jul 29', spot: 'Cafe Zupas', address: '3750 N Thanksgiving Way, Ste 100, Lehi, UT 84043' },
      { date: 'Aug 5', spot: 'Smashburger', address: '3700 N Thanksgiving Way, Ste C, Lehi, UT 84043' },
      { date: 'Aug 12', spot: 'Cafe Rio', address: '1851 W Traverse Pkwy, Lehi, UT 84043' },
      { date: 'Aug 19', spot: 'Costa Vida', address: '1578 E 3500 N, Ste 101, Lehi, UT 84043' },
      { date: 'Aug 26', spot: 'Super Chix', address: '643 Pacific Dr, Ste 102, American Fork, UT 84003' },
      { date: 'Sep 2', spot: 'Village Baker', address: '3320 N Digital Dr, Lehi, UT 84043' },
      { date: 'Sep 9', spot: 'Noodles & Company', address: '3601 Digital Dr, Ste 204, Lehi, UT 84043' },
      { date: 'Sep 16', spot: 'Zao Asian Cafe', address: '1249 E Main St, Ste 100, Lehi, UT 84043' },
      { date: 'Sep 23', spot: 'Red Fuego', address: '1820 W Traverse Pkwy, Lehi, UT 84043' },
      { date: 'Sep 30', spot: 'Pizzeria Limone', address: '1249 E Main St, Ste 120, Lehi, UT 84043' },
      { date: 'Oct 7', spot: 'The Smoked Taco', address: '933 W 500 N, Ste 102, American Fork, UT 84003' },
      { date: 'Oct 14', spot: "Paco's Tacos", address: '114 S 850 E, Lehi, UT 84043' },
      { date: 'Oct 21', spot: 'Spitz', address: '3601 N Digital Dr, Ste 210, Lehi, UT 84043' },
    ],
  },
  {
    id: 'hobby-nights',
